...
# to every package ID (and therefore to the generated binaries).
set(_BUILD_PROFILE "${_PROFILES_DIR}/build-linux.jinja")
if(NOT EXISTS "${_BUILD_PROFILE}")
    message(FATAL_ERROR "Missing deterministic Conan build profile: ${_BUILD_PROFILE}")
endif()
set(CONAN_HOST_PROFILE "${_SELECTED_PROFILE};auto-cmake" CACHE STRING "Conan host profile")
set(CONAN_BUILD_PROFILE "${_BUILD_PROFILE}" CACHE STRING "Conan build profile")
